...
MANUFACTURER_GUIDANCE = {
    ...
    "River": {
        "source_name": "River Mobility",
        "source_url": "https://www.rideriver.com/",
    },
    "Ampere": {
        "source_name": "Ampere Electric",
        "source_url": "https://ampere.greaveselectricmobility.com/",
    },
    "Vespa": {
        "source_name": "Vespa India",
        "source_url": "https://vespaindia.com/",
    },
    "Aprilia": {
        "source_name": "Aprilia India",
        "source_url": "https://apriliaindia.com/",
    },
}


CATALOG_SOURCE_REFRESHED_ON = "2026-07-31"
CATALOG_SOURCE_REFRESH_POLICY_DAYS = 45
...
def _catalog_entry(
    ...
    *,
    ...
    source_checked_on: str = CATALOG_SOURCE_REFRESHED_ON,
) -> dict:
    return {
...
EXTENDED_OFFICIAL_BIKE_CATALOG = [
    ...
    _catalog_entry(
        ...
        ["alto k10", "maruti alto", "alto"],
        maintenance_highlights=[
            {"label": "City Clutch And Cooling Review", "interval": "At annual service and after stop-go months", "note": "Small city hatchbacks show clutch, battery, cooling-fan, and tyre-pressure drift quickly in short-trip use."},
        ],
    ),
    _catalog_entry(
        ...
        ["wagonr", "wagon r", "maruti wagonr", "maruti wagon r"],
        maintenance_highlights=[
            {"label": "Tall-Hatch Tyre And Body-Roll Check", "interval": "Every 10,000 km or after rough-road months", "note": "Tall hatchbacks benefit from disciplined tyre pressure, suspension, and alignment checks to keep steering stable."},
        ],
    ),
    _catalog_entry(
        "maruti-suzuki-fronx",
        ...
        ["fronx", "maruti fronx", "nexa fronx"],
        maintenance_highlights=[
            {"label": "Turbo/City Intake And Alignment Review", "interval": "At annual service and after dusty travel", "note": "Crossover city use can hide filter clogging, tyre wear, and alignment drift until mileage or steering feel changes."},
        ],
    ),
    _catalog_entry(
        ...
        ["grand vitara", "maruti grand vitara", "nexa grand vitara"],
        fuel_type="hybrid",
        maintenance_highlights=[
            {"label": "Hybrid Battery Airflow And Tyre Efficiency", "interval": "At service and before long summer trips", "note": "Hybrid crossover efficiency depends on battery airflow, tyre pressure, cabin filter, and alignment staying clean."},
        ],
    ),
    _catalog_entry(
        "hyundai-verna",
        ...
        95,
        "Hyundai Motor India",
        "https://www.hyundai.com/in/en/find-a-car/verna/highlights",
        ["verna", "hyundai verna"],
        maintenance_highlights=[
            {"label": "Sedan Tyre Edge And Brake Fluid Review", "interval": "Before expressway runs and at annual service", "note": "Long wheelbase sedans can feel stable even while alignment, tyre shoulder wear, or brake-fluid age is drifting."},
        ],
    ),
    _catalog_entry(
        "hyundai-alcazar",
        ...
        fuel_type="diesel",
        maintenance_highlights=[
            {"label": "Three-Row Load And Cooling Check", "interval": "Before family highway travel", "note": "Three-row SUV loading raises brake, tyre, suspension, cooling, and cabin-filter pressure beyond solo city use."},
        ],
    ),
    _catalog_entry(
        "tata-altroz",
        ...
        88,
        "Tata Motors",
        "https://cars.tatamotors.com/altroz/ice.html",
        ["altroz", "tata altroz"],
        maintenance_highlights=[
            {"label": "Premium-Hatch Alignment And Brake Review", "interval": "At annual service and after pothole-heavy months", "note": "Wide tyres and heavier hatchback bodies make alignment, pad wear, and tyre pressure important for mileage stability."},
        ],
    ),
    _catalog_entry(
        "tata-safari",
        ...
        fuel_type="diesel",
        maintenance_highlights=[
            {"label": "Large-SUV Diesel And Brake Heat Review", "interval": "Before hills, full loads, or long highway runs", "note": "Heavy diesel SUVs should tighten tyre, brake-fluid, cooling, and DPF-style drive-pattern checks."},
        ],
    ),
    _catalog_entry(
        "tata-curvv",
        ...
        92,
        "Tata Motors",
        "https://cars.tatamotors.com/curvv/ice.html",
        ["curvv", "tata curvv", "curvv ice"],
        maintenance_highlights=[
            {"label": "Coupe-SUV Tyre And ADAS Sensor Cleanliness", "interval": "Monthly and after highway dust", "note": "Sloped-body SUVs still need ordinary tyre, brake, suspension, and sensor-cleanliness checks to keep driver aids useful."},
        ],
    ),
    _catalog_entry(
        "tata-punch-ev",
        ...
        ["punch ev", "tata punch ev", "punch.ev"],
        fuel_type="electric",
        maintenance_highlights=[
            {"label": "Small-EV Range And Brake Regen Review", "interval": "Monthly", "note": "Compact EV range depends heavily on tyre drag, brake regen feel, battery temperature, and charging habits."},
        ],
    ),
    _catalog_entry(
        "mahindra-bolero-neo",
        ...
        88,
        "Mahindra Auto",
        "https://auto.mahindra.com/suv/bolero-neo/NEO.html",
        ["bolero neo", "mahindra bolero neo", "bolero"],
        fuel_type="diesel",
        maintenance_highlights=[
            {"label": "Utility-SUV Undercarriage And Suspension Review", "interval": "After rural, loaded, or bad-road use", "note": "Utility usage should pull suspension, underbody, tyre, brake, and driveline checks forward."},
        ],
    ),
    _catalog_entry(
        "mahindra-xuv400",
        ...
        90,
        "Mahindra Auto",
        "https://auto.mahindra.com/suv/xuv400",
        ["xuv400", "mahindra xuv400", "xuv 400"],
        fuel_type="electric",
        maintenance_highlights=[
            {"label": "EV Tyre Wear And Battery Thermal Review", "interval": "Monthly and before highway charging stops", "note": "High-torque EVs should track tyre wear, brake regen smoothness, charging heat, and software state together."},
        ],
    ),
    _catalog_entry(
        "kia-syros",
        ...
        ["syros", "kia syros"],
        maintenance_highlights=[
            {"label": "Compact-SUV Sensor And Tyre Review", "interval": "Monthly and after monsoon drives", "note": "ADAS-heavy compact SUVs need ordinary tyre, brake, camera/sensor, and alignment checks to stay trustworthy."},
        ],
    ),
    _catalog_entry(
        "kia-syros-ev",
        ...
        90,
        "Kia India",
        "https://www.kia.com/in/our-vehicles/syros-ev/showroom.html",
        ["syros ev", "kia syros ev"],
        fuel_type="electric",
        maintenance_highlights=[
            {"label": "EV Fast-Charge And Tyre Efficiency Review", "interval": "Monthly and before outstation charging", "note": "EV crossover range is sensitive to tyre pressure, fast-charge heat, brake drag, and payload."},
        ],
    ),
    _catalog_entry(
        "toyota-glanza",
        ...
        maintenance_highlights=[
            {"label": "Urban-Hatch Fuel And Alignment Review", "interval": "At annual service and after rough-road months", "note": "Tyre pressure, alignment, air-filter state, and brake drag influence real-world hatchback mileage quickly."},
        ],
    ),
    _catalog_entry(
        "toyota-fortuner",
        ...
        fuel_type="diesel",
        maintenance_highlights=[
            {"label": "4x4/Heavy-SUV Brake And Undercarriage Audit", "interval": "After off-road, hill, towing, or loaded highway use", "note": "Heavy body-on-frame SUVs should pull brake, tyre, suspension, driveline, and underbody checks forward after hard use."},
        ],
    ),
    _catalog_entry(
        "toyota-rumion",
        ...
        maintenance_highlights=[
            {"label": "Family-MPV Load And AC Filter Review", "interval": "Before school-run seasons and family trips", "note": "Seven-seat use raises cabin-filter, tyre-pressure, brake, and suspension wear signals."},
        ],
    ),
    _catalog_entry(
        ...
        ["taisor", "urban cruiser taisor", "toyota taisor"],
        maintenance_highlights=[
            {"label": "Crossover Alignment And Intake Review", "interval": "At annual service and after dusty or broken-road use", "note": "Compact crossovers benefit from early intake, tyre, alignment, and brake checks when used on mixed roads."},
        ],
    ),
    _catalog_entry(
        "mg-windsor-ev",
        ...
        ["windsor ev", "mg windsor", "mg windsor ev"],
        fuel_type="electric",
        maintenance_highlights=[
            {"label": "CUV-EV Tyre, Cabin Load, And Charging Review", "interval": "Monthly and before long charging days", "note": "Cabin-heavy EV use should monitor tyre drag, brake regen, battery heat, and charging cadence."},
        ],
    ),
    _catalog_entry(
        "mg-zs-ev",
        ...
        ["zs ev", "mg zs ev", "mg zsev"],
        fuel_type="electric",
        maintenance_highlights=[
            {"label": "EV SUV Tyre And Battery-Cooling Review", "interval": "Monthly and before expressway charging", "note": "Electric SUVs add tyre load and thermal load; compare real range against route, payload, and charging behavior."},
        ],
    ),
    _catalog_entry(
        "citroen-basalt",
        ...
        ["basalt", "citroen basalt"],
        maintenance_highlights=[
            {"label": "Coupe-Crossover Suspension And Tyre Review", "interval": "After rough-road months and before highway travel", "note": "Comfort-focused crossovers should monitor tyre shoulders, suspension noise, brake feel, and cooling load."},
        ],
    ),
    _catalog_entry(
        "hero-hf-deluxe",
        ...
        55,
        "Hero MotoCorp",
        "https://www.heromotocorp.com/en-in/motorcycles/practical/hf-deluxe.html",
        ["hf deluxe", "hero hf deluxe", "hf"],
        maintenance_highlights=[
            {"label": "High-Mileage Commuter Oil And Cable Review", "interval": "At service and every heavy commute month", "note": "Daily economy bikes show maintenance drift as mileage loss, clutch cable stretch, brake-shoe wear, and plug fouling."},
        ],
    ),
    _catalog_entry(
        "honda-shine-125",
        ...
        ["shine", "shine 125", "honda shine"],
        maintenance_highlights=[
            {"label": "Commuter Mileage And Brake-Shoe Review", "interval": "At each service", "note": "Workhorse 125cc usage should track plug, air filter, brake-shoe wear, clutch free-play, and tyre pressure together."},
        ],
    ),
    _catalog_entry(
        "bajaj-platina-110",
        ...
        58,
        "Bajaj Auto",
        "https://www.bajajauto.com/bikes/platina/platina-110",
        ["platina", "platina 110", "bajaj platina"],
        maintenance_highlights=[
            {"label": "Economy-Bike Chain And Ride-Comfort Check", "interval": "Every service and after rough-road months", "note": "Daily commuter comfort depends on tyre pressure, suspension, chain slack, brake shoes, and basic tune staying stable."},
        ],
    ),
    _catalog_entry(
        "tvs-ronin",
        ...
        ["ronin", "tvs ronin"],
        maintenance_highlights=[
            {"label": "Roadster Chain, Brake, And Suspension Review", "interval": "Before touring and at service", "note": "Mixed city-touring use should pull chain, pad, tyre, and suspension checks forward when luggage or bad roads are involved."},
        ],
    ),
    _catalog_entry(
        ...
        75,
        "Royal Enfield",
        "https://www.royalenfield.com/in/en/motorcycles/bullet-350/",
        ["bullet 350", "re bullet", "royal enfield bullet"],
        maintenance_highlights=[
            {"label": "Long-Stroke Clutch And Chain Review", "interval": "At service and after rain-heavy use", "note": "Classic single-cylinder use should track clutch feel, chain slack, brake pads, tyre pressure, and oil age."},
        ],
    ),
    _catalog_entry(
        ...
        ["guerrilla 450", "re guerrilla", "royal enfield guerrilla"],
        maintenance_highlights=[
            {"label": "Liquid-Cooled Roadster Heat And Brake Review", "interval": "Before summer traffic and spirited rides", "note": "Higher-output roadsters need coolant, fan, brake, tyre, chain, and clutch checks before heat or grip issues harden."},
        ],
    ),
    _catalog_entry(
        "yamaha-mt-15-v2",
        ...
        ["mt 15", "mt-15", "yamaha mt15", "yamaha mt-15"],
        maintenance_highlights=[
            {"label": "High-Rev Streetfighter Chain And Coolant Review", "interval": "Every service and after aggressive use", "note": "Light sport bikes react quickly to chain slack, coolant condition, brake heat, and tyre pressure drift."},
        ],
    ),
    _catalog_entry(
        "honda-hornet-2-0",
        ...
        ["hornet", "hornet 2.0", "honda hornet"],
        maintenance_highlights=[
            {"label": "USD-Fork, Brake, And Tyre Review", "interval": "At service and after bad-road use", "note": "Streetfighter use should watch fork feel, front brake heat, tyre pressure, chain slack, and clutch smoothness."},
        ],
    ),
    _catalog_entry(
        "bajaj-dominar-400",
        ...
        95,
        "Bajaj Auto",
        "https://www.bajajauto.com/bikes/dominar/dominar-400",
        ["dominar", "dominar 400", "bajaj dominar"],
        maintenance_highlights=[
            {"label": "Touring Brake, Coolant, And Chain Review", "interval": "Before long highway or hill rides", "note": "Touring singles need brake-fluid, coolant, tyre, chain, and luggage-load checks before sustained high-speed use."},
        ],
    ),
    _catalog_entry(
        ...
        ["apache rtr 200", "rtr 200 4v", "tvs apache 200"],
        maintenance_highlights=[
            {"label": "Ride-Mode Brake And Tyre Edge Check", "interval": "After fast rides and at each service", "note": "Sport-commute use should keep tyre pressure, brake pads, clutch feel, chain slack, and oil age close to spec."},
        ],
    ),
    _catalog_entry(
        "suzuki-gixxer-250",
        ...
        "Suzuki Motorcycle India",
        "https://www.suzukimotorcycle.co.in/product-details/gixxer-sf-250",
        ["gixxer 250", "suzuki gixxer 250", "gixxer"],
        maintenance_highlights=[
            {"label": "Oil-Cooled Street Sport Review", "interval": "Before highway and after dusty rides", "note": "Quarter-liter sport use should track oil, intake, brake, tyre, chain, and cooling-fin cleanliness together."},
        ],
    ),
    _catalog_entry(
        "honda-dio-125",
        ...
        ["dio 125", "honda dio", "dio"],
        maintenance_highlights=[
            {"label": "Sport-Scooter CVT And Fork Review", "interval": "At service and after rough-road months", "note": "Sporty scooter use should watch CVT judder, front fork noise, brake feel, tyre drag, and belt wear."},
        ],
    ),
    _catalog_entry(
        "suzuki-avenis-125",
        ...
        54,
        "Suzuki Motorcycle India",
        "https://www.suzukimotorcycle.co.in/product-details/avenis",
        ["avenis", "avenis 125", "suzuki avenis"],
        maintenance_highlights=[
            {"label": "Street-Scooter CVT And Brake Review", "interval": "At service and after stop-go months", "note": "Urban sporty scooters show belt, clutch, brake, tyre, and fork wear through pickup vibration and mileage drift."},
        ],
    ),
    _catalog_entry(
        "vida-vx2-plus",
        ...
        60,
        "VIDA",
        "https://www.vidaworld.com/vx2-plus-electric-scooter.html",
        ["vida vx2", "vx2 plus", "vida scooter"],
        fuel_type="electric",
        maintenance_highlights=[
            {"label": "Removable-Battery And Tyre Drag Review", "interval": "Monthly", "note": "Removable-battery EV scooters need charge-contact, tyre, brake-drag, bearing, and range-drift checks together."},
        ],
    ),
    _catalog_entry(
        "river-indie",
        ...
        70,
        "River Mobility",
        "https://www.rideriver.com/indie",
        ["river indie", "indie scooter", "river scooter"],
        fuel_type="electric",
        maintenance_highlights=[
            {"label": "Utility-EV Load And Chain-Drive Review", "interval": "Monthly and after cargo-heavy use", "note": "Utility EV scooters should track payload, tyre wear, chain-drive smoothness, brake regen, storage mounts, and battery range."},
        ],
    ),
    _catalog_entry(
        "ampere-magnus-neo",
        ...
        55,
        "Ampere Electric",
        "https://ampere.greaveselectricmobility.com/magnus-neo",
        ["ampere magnus", "magnus neo", "ampere scooter"],
        fuel_type="electric",
        maintenance_highlights=[
            {"label": "Family-EV Battery Health And Brake Drag", "interval": "Monthly", "note": "Budget EV scooters need practical checks for tyre pressure, brake drag, charger habit, battery connector heat, and real range."},
        ],
    ),
    _catalog_entry(
        "vespa-s-150",
        ...
        58,
        "Vespa India",
        "https://vespaindia.com/vespa-s",
        ["vespa s 150", "vespa 150", "vespa s"],
        maintenance_highlights=[
            {"label": "Steel-Body Scooter Suspension And Brake Review", "interval": "At service and after rough-road months", "note": "Premium steel-body scooters should monitor front suspension, brake feel, tyre pressure, belt wear, and body fasteners."},
        ],
    ),
    _catalog_entry(
        "aprilia-sr-160",
        ...
        62,
        "Aprilia India",
        "https://apriliaindia.com/aprilia-SR-160cc-sports-scooter",
        ["aprilia sr 160", "sr 160", "aprilia scooter"],
        maintenance_highlights=[
            {"label": "Sport-Scooter Tyre Edge And CVT Review", "interval": "At service and after aggressive city use", "note": "Large sporty scooters need belt, clutch, front brake, tyre edge, and fork checks earlier than commuter scooters."},
        ],
    ),
    _catalog_entry(
        "tvs-jupiter-125",
        ...
        52,
        "TVS Motor",
        "https://www.tvsmotor.com/tvs-jupiter-125/disc",
        ["jupiter 125", "tvs jupiter 125"],
        maintenance_highlights=[
            {"label": "Family-Scooter Service Window And CVT Review", "interval": "Every 6,000 km or 6 months", "note": "Family scooters should track belt smoothness, brake shoes, fork noise, tyre pressure, and under-seat load effects."},
        ],
    ),
    _catalog_entry(
        "honda-activa-e",
        ...
        ["activa e", "activa electric", "honda activa e"],
        fuel_type="electric",
        maintenance_highlights=[
            {"label": "Swap-Battery And Brake Regen Review", "interval": "Monthly", "note": "Swappable-battery scooters should track pack seating, connector heat, tyre drag, regen feel, and range consistency."},
        ],
    ),
    _catalog_entry(
        "suzuki-e-access",
        ...
        ["e access", "e-access", "suzuki e access"],
        fuel_type="electric",
        maintenance_highlights=[
            {"label": "LFP Battery And Charger Habit Review", "interval": "Monthly", "note": "Daily EV scooter reliability depends on charger cadence, tyre pressure, brake drag, bearing noise, and software state."},
        ],
    ),
    _catalog_entry(
        ...
        55,
        "Yamaha Motor India",
        "https://www.yamaha-motor-india.com/yamaha-ray-zr125fihybrid.html",
        ["rayzr", "ray zr", "yamaha rayzr", "rayzr 125"],
        fuel_type="hybrid",
        maintenance_highlights=[
            {"label": "Hybrid-Assist Battery And CVT Review", "interval": "At service and after dense traffic months", "note": "Mild-hybrid scooters should track battery voltage, CVT response, brake drag, tyre pressure, and start-stop behavior."},
        ],
    ),
    _catalog_entry(
        "hero-destini-125",
        ...
        52,
        "Hero MotoCorp",
        "https://www.heromotocorp.com/en-in/scooters/new-destini-125.html",
        ["destini", "destini 125", "hero destini"],
        maintenance_highlights=[
            {"label": "Family-Scooter Mileage And Belt Review", "interval": "At service and after heavy city use", "note": "Everyday scooter use should track belt smoothness, brake shoes, plug, air filter, fork noise, and tyre pressure."},
        ],
    ),
]
...
def apply_class_defaults(data: dict) -> dict:
    ...
    if not merged.get("source_checked_on"):
        merged["source_checked_on"] = CATALOG_SOURCE_REFRESHED_ON
...
def catalog_coverage_summary() -> dict:
    ...
    source_checked_ready = sum(1 for item in items if item.get("source_checked_on"))
    ...
    completion_ready = (
        ...
        and source_checked_ready == model_count
    ...
    return {
        ...
        "source_checked_coverage_pct": round((source_checked_ready / max(model_count, 1)) * 100),
        "maintenance_guidance_coverage_pct": round((guidance_ready / max(model_count, 1)) * 100),
        "source_refresh": {
            "last_checked_on": CATALOG_SOURCE_REFRESHED_ON,
            "refresh_policy_days": CATALOG_SOURCE_REFRESH_POLICY_DAYS,
            "official_source_count": source_ready,
            "source_checked_count": source_checked_ready,
        },
...
def infer_bike_class(value: str) -> str:
    ...
    if any(token in normalized for token in ["creta", "nexon", "suv", "thar", "harrier", "fronx", "vitara", "alcazar", "safari", "curvv", "bolero", "xuv400", "syros", "fortuner", "taisor", "windsor", "zs ev", "basalt"]):
        return "suv"
    if any(token in normalized for token in ["dzire", "verna", "city", "sedan"]):
        return "sedan"
    if any(token in normalized for token in ["swift", "i20", "baleno", "altroz", "alto", "wagonr", "glanza", "hatchback"]):
        return "hatchback"
    if any(token in normalized for token in ["ertiga", "carens", "rumion", "mpv"]):
        return "mpv"
    ...
    if any(token in normalized for token in ["cruiser", "avenger"]):
        return "cruiser"
    if any(token in normalized for token in ["raider", "sp", "shine", "splendor", "hf deluxe", "platina", "commuter"]):
        return "commuter"
    if any(token in normalized for token in ["rr", "rc", "r15", "ninja", "sport", "hornet", "dominar", "apache", "gixxer"]):
        return "sport"
    return "roadster"
...
def infer_vehicle_type(value: str) -> str:
    normalized = normalize_bike_name(value)
    if any(token in normalized for token in ["car", "hatchback", "sedan", "suv", "swift", "dzire", "creta", "nexon", "alto", "baleno", "wagonr", "fronx", "vitara", "verna", "alcazar", "altroz", "safari", "curvv", "punch", "bolero", "xuv400", "syros", "glanza", "fortuner", "rumion", "taisor", "windsor", "zs ev", "basalt"]):
        return "car"
    if any(token in normalized for token in ["scooter", "activa", "jupiter", "ntorq", "dio", "avenis", "vida", "river", "indie", "ampere", "magnus", "vespa", "aprilia", "e access", "rayzr", "destini"]):
        return "scooter"
    return "motorcycle"
